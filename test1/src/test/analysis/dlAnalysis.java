    ...
    public void findSlave(){
        ...
        for(Pair p1 : mappings){
            ...
            for(Pair ps1 : maps1){
                ...
                String a1s = (String)ps1.getValue();
                ...
                for(Pair p2 : mappings){
                    ...
                    if(a1rt.equals(currentActor2)){
                        ...
                        for(Pair ps2 : maps2){
                            ...
                            //System.out.println(currentActor2+" "+a2r+" "+currentActor1);
                            if(a2rt.equals(currentActor1)){
                                if(!a1s.equals("null") || !a2s.equals("null")){
                                    //System.out.println(a2s+" "+a1s);
                                    flag = true;
                                    break;
                                }
                            }
                        }
                        if(!flag && a1s.equals("null"))
