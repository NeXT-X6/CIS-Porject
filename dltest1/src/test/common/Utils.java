...
public class Utils {
    ...
    public static String[] getSootArgs(String analysisToRun, String classToAnalyze) {
        ...
        rtJarPath += pathSeparator + "lib" + separator + "akka-actor_2.12-2.6.0-M5.jar";
        rtJarPath += pathSeparator + "lib" + separator + "akka-testkit_2.12-2.6.0-M5.jar";
        rtJarPath += pathSeparator + "lib" + separator + "scala-library-2.12.8.jar";
        rtJarPath += pathSeparator + "lib" + separator + "junit-4.11.jar";
        rtJarPath += pathSeparator + "lib" + separator + "hamcrest-core-1.3.jar";
        rtJarPath += pathSeparator + "lib" + separator + "soot-trunk.jar";
        rtJarPath += pathSeparator + "lib" + separator + "config-1.3.4.jar";
        rtJarPath += pathSeparator + "lib" + separator + "scala-java8-compat_2.12-0.8.0.jar";
        String sootClasspath = rtJarPath + pathSeparator + "build";
        String [] args = { "-process-path", "src/main/java", "-cp", sootClasspath, "-keep-line-number", "-f", "J", "-p", analysisToRun, "on", classToAnalyze };
        return args;
    }
